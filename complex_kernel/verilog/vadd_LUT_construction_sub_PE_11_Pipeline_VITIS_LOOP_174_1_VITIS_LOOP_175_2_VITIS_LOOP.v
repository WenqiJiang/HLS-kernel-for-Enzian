...
module vadd_LUT_construction_sub_PE_11_Pipeline_VITIS_LOOP_174_1_VITIS_LOOP_175_2_VITIS_LOOP (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [8:0] k_fu_166;
wire   [8:0] select_ln175_38_fu_880_p3;
reg   [11:0] indvar_flatten_fu_170;
wire   [11:0] select_ln175_39_fu_786_p3;
reg   [11:0] ap_sig_allocacmp_indvar_flatten_load_19;
reg   [11:0] ap_sig_allocacmp_indvar_flatten_load;
reg   [2:0] i_fu_174;
wire   [2:0] select_ln174_39_fu_739_p3;
...
wire   [2:0] empty_957_fu_639_p2;
wire   [4:0] p_shl_fu_631_p3;
wire   [4:0] p_shl169_cast_fu_645_p1;
wire   [2:0] add_ln174_15_fu_679_p2;
wire   [1:0] empty_959_fu_685_p1;
wire   [2:0] empty_960_fu_697_p2;
wire   [4:0] p_shl_mid1_fu_689_p3;
wire   [4:0] p_shl169_cast_mid1_fu_703_p1;
wire   [4:0] sub_ln178_13_fu_707_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln174_fu_655_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_174 <= select_ln174_39_fu_739_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln174_fu_655_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten_fu_170 <= select_ln175_39_fu_786_p3;
        end else if ((ap_loop_init == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            k_fu_166 <= select_ln175_38_fu_880_p3;
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_i_32 = i_fu_174;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_indvar_flatten_load_19 = 12'd0;
    end else begin
        ap_sig_allocacmp_indvar_flatten_load_19 = indvar_flatten_fu_170;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        s_product_quantizer_init_sub_PE_i_11_blk_n = s_product_quantizer_init_sub_PE_i_11_empty_n;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        s_product_quantizer_init_sub_PE_i_11_read = 1'b1;
    end else begin
...
assign add_ln174_15_fu_679_p2 = (ap_sig_allocacmp_i_32 + 3'd1);

assign add_ln174_fu_661_p2 = (ap_sig_allocacmp_indvar_flatten37_load + 13'd1);

assign add_ln175_13_fu_780_p2 = (ap_sig_allocacmp_indvar_flatten_load + 12'd1);

assign add_ln175_fu_835_p2 = (select_ln174_fu_817_p3 + 9'd1);

assign add_ln176_fu_774_p2 = (select_ln175_fu_753_p3 + 3'd1);

assign add_ln178_fu_765_p2 = (select_ln174_37_fu_713_p3 + zext_ln178_fu_761_p1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((s_product_quantizer_init_sub_PE_i_11_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((s_product_quantizer_init_sub_PE_i_11_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (s_product_quantizer_init_sub_PE_i_11_empty_n == 1'b0);
end
...
assign ap_int_blocking_cur_n = s_product_quantizer_init_sub_PE_i_11_blk_n;
...
assign empty_957_fu_639_p2 = ap_sig_allocacmp_i_32 << 3'd1;

assign empty_959_fu_685_p1 = add_ln174_15_fu_679_p2[1:0];

assign empty_960_fu_697_p2 = add_ln174_15_fu_679_p2 << 3'd1;

assign empty_fu_627_p1 = ap_sig_allocacmp_i_32[1:0];

assign icmp_ln174_fu_655_p2 = ((ap_sig_allocacmp_indvar_flatten37_load == 13'd6144) ? 1'b1 : 1'b0);

assign icmp_ln175_fu_673_p2 = ((ap_sig_allocacmp_indvar_flatten_load_19 == 12'd1536) ? 1'b1 : 1'b0);
...
assign p_shl169_cast_fu_645_p1 = empty_957_fu_639_p2;

assign p_shl169_cast_mid1_fu_703_p1 = empty_960_fu_697_p2;

assign p_shl_fu_631_p3 = {{empty_fu_627_p1}, {3'd0}};

assign p_shl_mid1_fu_689_p3 = {{empty_959_fu_685_p1}, {3'd0}};

assign select_ln174_37_fu_713_p3 = ((icmp_ln175_fu_673_p2[0:0] == 1'b1) ? sub_ln178_13_fu_707_p2 : sub_ln178_fu_649_p2);

assign select_ln174_38_fu_828_p3 = ((icmp_ln175_reg_959[0:0] == 1'b1) ? 8'd0 : trunc_ln174_fu_824_p1);

assign select_ln174_39_fu_739_p3 = ((icmp_ln175_fu_673_p2[0:0] == 1'b1) ? add_ln174_15_fu_679_p2 : ap_sig_allocacmp_i_32);

assign select_ln174_fu_817_p3 = ((icmp_ln175_reg_959[0:0] == 1'b1) ? 9'd0 : k_fu_166);

assign select_ln175_37_fu_845_p3 = ((and_ln174_reg_965[0:0] == 1'b1) ? trunc_ln175_fu_841_p1 : select_ln174_38_fu_828_p3);

assign select_ln175_38_fu_880_p3 = ((and_ln174_reg_965[0:0] == 1'b1) ? add_ln175_fu_835_p2 : select_ln174_fu_817_p3);

assign select_ln175_39_fu_786_p3 = ((icmp_ln175_fu_673_p2[0:0] == 1'b1) ? 12'd1 : add_ln175_13_fu_780_p2);

assign select_ln175_fu_753_p3 = ((or_ln175_fu_747_p2[0:0] == 1'b1) ? 3'd0 : ap_sig_allocacmp_j_load);

assign sub_ln178_13_fu_707_p2 = (p_shl_mid1_fu_689_p3 - p_shl169_cast_mid1_fu_703_p1);
...
assign tmp_fu_887_p1 = s_product_quantizer_init_sub_PE_i_11_dout;
...
assign zext_ln175_fu_852_p1 = select_ln175_37_fu_845_p3;

assign zext_ln178_fu_761_p1 = select_ln175_fu_753_p3;

endmodule //vadd_LUT_construction_sub_PE_11_Pipeline_VITIS_LOOP_174_1_VITIS_LOOP_175_2_VITIS_LOOP
