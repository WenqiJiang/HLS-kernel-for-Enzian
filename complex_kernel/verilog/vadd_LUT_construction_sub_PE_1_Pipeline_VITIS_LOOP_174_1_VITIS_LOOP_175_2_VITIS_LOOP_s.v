...
module vadd_LUT_construction_sub_PE_1_Pipeline_VITIS_LOOP_174_1_VITIS_LOOP_175_2_VITIS_LOOP_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [11:0] ap_sig_allocacmp_indvar_flatten_load_14;
reg   [11:0] ap_sig_allocacmp_indvar_flatten_load;
reg   [2:0] i_fu_174;
wire   [2:0] select_ln174_27_fu_739_p3;
reg   [2:0] ap_sig_allocacmp_i_27;
...
wire   [2:0] empty_913_fu_639_p2;
wire   [4:0] p_shl_fu_631_p3;
wire   [4:0] p_shl169_cast_fu_645_p1;
wire   [2:0] add_ln174_11_fu_679_p2;
wire   [1:0] empty_915_fu_685_p1;
wire   [2:0] empty_916_fu_697_p2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_i_27 = 3'd0;
    end else begin
        ap_sig_allocacmp_i_27 = i_fu_174;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_indvar_flatten_load_14 = 12'd0;
    end else begin
        ap_sig_allocacmp_indvar_flatten_load_14 = indvar_flatten_fu_170;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        s_product_quantizer_init_sub_PE_i_1_blk_n = s_product_quantizer_init_sub_PE_i_1_empty_n;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        s_product_quantizer_init_sub_PE_i_1_read = 1'b1;
    end else begin
...
assign add_ln174_11_fu_679_p2 = (ap_sig_allocacmp_i_27 + 3'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((s_product_quantizer_init_sub_PE_i_1_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((s_product_quantizer_init_sub_PE_i_1_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (s_product_quantizer_init_sub_PE_i_1_empty_n == 1'b0);
end
...
assign ap_int_blocking_cur_n = s_product_quantizer_init_sub_PE_i_1_blk_n;
...
assign empty_913_fu_639_p2 = ap_sig_allocacmp_i_27 << 3'd1;

assign empty_915_fu_685_p1 = add_ln174_11_fu_679_p2[1:0];

assign empty_916_fu_697_p2 = add_ln174_11_fu_679_p2 << 3'd1;

assign empty_fu_627_p1 = ap_sig_allocacmp_i_27[1:0];

assign icmp_ln174_fu_655_p2 = ((ap_sig_allocacmp_indvar_flatten37_load == 13'd6144) ? 1'b1 : 1'b0);

assign icmp_ln175_fu_673_p2 = ((ap_sig_allocacmp_indvar_flatten_load_14 == 12'd1536) ? 1'b1 : 1'b0);
...
assign p_shl169_cast_fu_645_p1 = empty_913_fu_639_p2;

assign p_shl169_cast_mid1_fu_703_p1 = empty_916_fu_697_p2;

assign p_shl_fu_631_p3 = {{empty_fu_627_p1}, {3'd0}};

assign p_shl_mid1_fu_689_p3 = {{empty_915_fu_685_p1}, {3'd0}};
...
assign select_ln174_27_fu_739_p3 = ((icmp_ln175_fu_673_p2[0:0] == 1'b1) ? add_ln174_11_fu_679_p2 : ap_sig_allocacmp_i_27);
...
assign tmp_fu_887_p1 = s_product_quantizer_init_sub_PE_i_1_dout;
...
endmodule //vadd_LUT_construction_sub_PE_1_Pipeline_VITIS_LOOP_174_1_VITIS_LOOP_175_2_VITIS_LOOP_s
